...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=i386 --cc='xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch i386 -mios-simulator-version-min=6.0' --extra-ldflags='-arch i386 -mios-simulator-version-min=6.0' --prefix=/ffmpeg/thin/i386
...
SRC_PATH=/ffmpeg/ffmpeg-3.1.5
SRC_LINK=src
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Apple LLVM version 8.0.0 (clang-800.0.38)
ARCH=x86
INTRINSICS=none
...
LDEXEFLAGS=
LDLIBFLAGS=
SHFLAGS=-dynamiclib -Wl,-single_module -Wl,-install_name,$(INSTALL_NAME_DIR)/$(SLIBNAME_WITH_MAJOR),-current_version,$(LIBVERSION),-compatibility_version,$(LIBMAJOR) -Wl,-read_only_relocs,suppress
ASMSTRIPFLAGS= -x
...
EXTRALIBS=-framework QuartzCore -framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework CoreVideo -framework CoreFoundation -framework AudioToolbox -framework CoreMedia -liconv -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=

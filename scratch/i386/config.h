...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=i386 --cc='xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch i386 -mios-simulator-version-min=6.0' --extra-ldflags='-arch i386 -mios-simulator-version-min=6.0' --prefix=/ffmpeg/thin/i386"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/ffmpeg/thin/i386/share/ffmpeg"
#define AVCONV_DATADIR "/ffmpeg/thin/i386/share/ffmpeg"
